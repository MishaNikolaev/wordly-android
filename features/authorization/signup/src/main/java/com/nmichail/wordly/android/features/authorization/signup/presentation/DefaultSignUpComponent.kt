...
internal class DefaultSignUpComponent @AssistedInject constructor(
	private val signUpStoreFactory: SignUpStoreFactory,
	@Assisted("componentContext") componentContext: ComponentContext,
	@Assisted("signUpRouter") private val signUpRouter: SignUpRouter,
	...
	@AssistedFactory
	fun interface Factory : SignUpComponent.Factory {
		override fun invoke(
			@Assisted("componentContext") componentContext: ComponentContext,
			@Assisted("signUpRouter") signUpRouter: SignUpRouter,
